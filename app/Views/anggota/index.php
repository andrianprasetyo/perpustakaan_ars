                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="anggota/create">
                            <button type="button" class="btn  btn-primary btn-lg"><i class="mr-2" data-feather="plus-circle"></i>Tambah Anggota</button>
                        </a>
                    </div>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <form action="/anggota/edit/<?= $item['id_anggota']; ?>" method="GET" class="d-inline">
                                                <button type="submit" class="btn btn-sm btn-icon btn-primary mr-3"><i data-feather="edit-2"></i></button>
                                            </form>
